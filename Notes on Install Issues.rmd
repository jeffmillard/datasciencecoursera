...
fatal: could not read Password for https://github.com/yourgithubusernamehere/datasciencecoursera: Device not configured*
...
I ended up having to do the following steps:

1. Remove connection to remote repository.  May not be necessary, ad may not be an accuracte description of what this command does.  But I did this first:  Go to the directory for the repository ("datasciencecoursera") on your comnputer and execute:

**git remote rm origin**


2. Delete the local copy of the repository.  I did this in terminal with the following command. Removing .git removes the saved versions of your files.  Deleting the files themselves does not!
...
Note, this used to be something like
